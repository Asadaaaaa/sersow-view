...
export default function Footer({ transparent }) {
  return (
    <div className={"w-full xl:px-24 lg:px-24 md:px-24 sm:px-24 ss:px-8 xl:py-6 lg:py-6 md:py-6 sm:py-5 ss:py-4 border-t-[1px] border-t-solid border-t-slate-700 relative z-[2] " + (transparent ? "bg-slate-900/20" : "bg-slate-900")}>
