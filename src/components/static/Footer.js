      ...
      <div className="flex justify-between">
        ...
        <div className="flex">
          <div className="flex gap-2 items-center">
            <Link href="/credits">
              <button className="flex items-center h-fit px-9 py-3  border-solid rounded-xl bg-gradient-to-b from-[#22D3EE] to-[#0EA5E9] transition ease-out delay-100 hover:to-[#22D3EE] hover:shadow-[0px_0px_12px_.5px_#22d3ee] active:shadow-[0_0_0_0] active:scale-[.92] active:from-[rgb(6 182 212)] active:to-[rgb(6 182 212)] active:delay-150">
