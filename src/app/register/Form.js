		...
		<div className="bg-[rgba(2,6,23,0.5)] px-28 py-12 border-solid border-2 border-slate-700 rounded-[50px] backdrop-blur-[2px]">
			<div className="flex flex-col gap-4 items-center">
				...
				<div className="w-full px-2 py-1">
						<button 
							disabled={loading}
							className={`${font.Satoshi_b2bold} w-full px-6 py-3 text-center text-white rounded-xl bg-gradient-to-b from-cyan-500 to-blue-500 hover:drop-shadow-[0px_0px_4px_rgba(34,211,238,0.4)] transition-all`}
							onClick={async() => {
								...
								await fetch(HOST + "/v1/auth/register", {
									method: 'POST',
									headers: {
										'Accept': '*/*',
