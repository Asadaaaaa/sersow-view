  ...
  useEffect(() => {
		async function detailsProject() {
          ...
          console.log(res.data);
            ...
            image1: res.data.preview === null ? null : res.data.preview[0] ? res.data.preview[0] : null,
            image2: res.data.preview === null ? null : res.data.preview[1] ? res.data.preview[1] : null,
            image3: res.data.preview === null ? null : res.data.preview[2] ? res.data.preview[2] : null,
