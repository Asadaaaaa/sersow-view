            ...
            <div className="p-6 bg-slate-900 rounded-lg w-96 " key={index}>
              <div className="border-b border-slate-700 flex items-center justify-between pb-4">
                ...
                <Popover placement="left-top">
                  ...
                  <Popover.Content>
                    <OptionsCard username={item.owner_username} isMyProject={item.isMyProject} title={item.title} />
                  </Popover.Content>
                </Popover>
              </div>
              ...
              {item.isLiked ? (
                ...
                <div className="px-10 cursor-pointer " onClick={() => copylink(item.owner_username)}>
