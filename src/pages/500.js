            ...
            <div>
                <div className="bg-slate-950 flex -mb-[122.91px] min-h-[calc(100vh-220.3px)]">
                    <div className="relative w-full mb-4">
                        <Image src={LGradient} className="mix-blend-hard-light float-right mt-24 z-[1] rotate-180 mt-24 scale-y-[-1]" />   
                        <Image src={RGradient} className="mix-blend-plus-lighter float-left z-[0] rotate-180 -translate-y-24 scale-y-[-1]" />
                    </div>
                    <div className="absolute w-full py-24 mt-2">
                        <div className="flex flex-col gap-y-16 -gap-x-8  items-center z-[2]">
                        <h1 className={`${font.Clash_display_d1bold} text-white flex items-center text-center pl-20`}><span className='text-cyan-500 absolute -translate-x-20 rotate-[-15deg]'>5</span> <Image src={IconNol}/> <Image className='-ml-16' src={IconNol}/> </h1>
